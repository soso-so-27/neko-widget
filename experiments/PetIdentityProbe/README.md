...
2026-09-08追記: Build 6はApple処理完了と本人向け内部テスト中を確認済み。実写はVisionの候補そのものが0件で、本人による元写真の表示方向の確認も完了した。次のBuild 7候補は[同じ1枚の画像形式比較](INPUT-FORMAT-COMPARISON.md)だけに限定する。写真の再選択、識別基準の緩和、本体への組み込みはしない。
