...
'''
    ...
    def test_window_and_cat_copy_name_the_actual_destination_or_object(self) -> None:
        ...
        self.assertIn('"猫ごとの写真・プロフィール"', settings)
        self.assertIn('.navigationTitle("猫ごとの写真")', profiles)
    ...
    def test_cat_pages_browse_before_editing_and_creation_can_start_from_a_photo(self) -> None:
        ...
        self.assertIn("CatProfileConfirmedPhotosView(", destination)
        self.assertNotIn("CatProfileDetailView(", destination)
