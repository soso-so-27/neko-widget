...
'''
    ...
    def test_albums_open_favorites_and_scoped_collections_without_a_false_purchase_action(self) -> None:
        ...
        self.assertIn('accessibilityIdentifier(showsHighlightArchive ? "albums-highlights-archive" : showsReflectionArchive ? "albums-reflections-archive" : "albums-root")', album_root)
        self.assertIn('accessibilityIdentifier("albums-favorites")', album_root)
        self.assertIn('.navigationTitle(showsHighlightArchive ? "ピックアップ" : showsReflectionArchive ? "月のまとめ・ムービー" : "アルバム")', album_root)
