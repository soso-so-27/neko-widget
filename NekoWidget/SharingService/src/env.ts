export interface Env {
  ...
  BILLING_APPLE_NOTIFICATION_HISTORY_RECOVERY_RUNTIME_ENABLED?: string;
...
export function billingAppleNotificationHistoryRecoveryRuntimeEnabled(
  env: Pick<Env, "BILLING_APPLE_NOTIFICATION_HISTORY_RECOVERY_RUNTIME_ENABLED">,
): boolean {
  return env.BILLING_APPLE_NOTIFICATION_HISTORY_RECOVERY_RUNTIME_ENABLED === "YES";
}
