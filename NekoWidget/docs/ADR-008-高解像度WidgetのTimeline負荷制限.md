...
> 2026-09-10追記：最大20枚の候補・最大2件のTimeline・既存の時刻基準は維持する。少数候補を20枠へ重複させる処理を廃止し、実際に使える写真を一巡する。旧版の水増しmanifestもWidget側で重複なしに読む。[現在の個人Widget表示ルール](個人Widgetの写真表示ルール.md)を参照。
