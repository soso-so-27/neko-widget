...
> **2026-08-17追記：** 「現在の1枚だけをデコードする」という記述はBuild 5当時の想定であり、WidgetKitが未来entryを受理時に評価する実機挙動と一致しなかった。Build 9以降はTimeline自体を最大2件へ制限する。[ADR-008](ADR-008-高解像度WidgetのTimeline負荷制限.md)を現行正本とする。
