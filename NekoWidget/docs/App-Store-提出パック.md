...
>
> 共有機能では、初期版は1台のiPhoneで合計3個まで、名前付きで招待制の「非公開なまど」を作成・参加・切り替えできます。保存形式は既存データとの互換性のため最大20個を保持でき、
...
6. Aのまど画面で「写真を届ける」を押し、CC0猫写真1枚を選ぶ。写真アプリの共有シートから「ねこのまど」を選び、一時保存してhost appへ戻る経路も利用できる。
